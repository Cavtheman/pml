...
\begin{figure}[H]
    \centering
    \subfloat[\centering label 1]{{\includegraphics[width=6.5cm]{images/diffusion.png} }}%
    \subfloat[\centering label 2]{{\includegraphics[width=6.5cm]{images/vae_sample.png} }}%
